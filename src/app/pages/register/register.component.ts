...
export class RegisterComponent implements OnInit {
  ...
  regiones:Array<any> = [
    ...
    {nombreRegion:  "Región de Los Lagos" , comunas: ["Puerto Montt", "Calbuco", "Cochamó", "Fresia", "FruVllar", "Los Muermos", "Llanquihue", "Maullín", "Puerto Varas", "Castro", "Ancud", "Chonchi", "Curaco de Vélez", "Dalcahue", "Puqueldón", "Queilén", "Quellón", "Quemchi", "Quinchao", "Osorno", "Puerto Octay", "Purranque", "Puyehue", "Río Negro", "San Juan de la Costa", "San Pablo", "Chaitén", "Futaleufú", "Hualaihué", "Palena"]},
  ...
  onSubmit() {
    ...
    if (user.firstname == "" || user.lastname == "" || user.email == "" || user.password == "" || user.idcard == "" || user.residence_address == "" || user.region == "" || user.commune == "" || confirmPassword == "") {
      this.inputError = "Debe llenar todos los campos para poder registrarse";
    }
    else {
      this.inputError = "";
    }
    ...
    if (user.password != confirmPassword) {
      this.confirmPwError = "Por favor ingrese la misma contraseña";
    }
    else {
      this.confirmPwError = "";
    }

    if (this.inputError == "" && this.confirmPwError == "") {
